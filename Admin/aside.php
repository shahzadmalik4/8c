...
else
{
    ...
    $mysquery= mysqli_query($con,"SELECT * from admin where email ='$admin'");
    $admin_data = mysqli_fetch_array($mysquery);
}
?>
                    ...
                    <ul class="navbar-nav ms-auto d-flex align-items-center">
                        ...
                        <li>
                            <a class="profile-pic" href="#">
                                <img src="uploads/Admin_profile/<?php echo $admin_data['profile'] ?>" alt="<?php echo $admin_data['username'] ?>" width="36"
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="catagories.php"
                                aria-expanded="false">
                                <i class="fas fa-align-justify" aria-hidden="true"></i>
                                <span class="hide-menu">Catagories</span>
                            </a>
                        </li>
